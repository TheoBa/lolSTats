...
def get_macro_db(df):
    macro_db = df[['gameid', 'league', 'date', 'patch', 'playoffs', 'gamelength', 'teamname', 'side', 'result', 'ban1', 'ban2', 'ban3', 'ban4', 'ban5']].drop_duplicates()
    macro_db = macro_db.merge(macro_db[['gameid', 'teamname', 'ban1', 'ban2', 'ban3', 'ban4', 'ban5']], how='inner', on='gameid', suffixes=['', '_opp'])
...
def get_micro_db(df):
    ...
    micro_db = micro_db.merge(micro_db[['gameid', 'position', 'champion', 'playername']], 
...
def get_champion_presence(micro, macro, champion):
    ...
    cdt_ban = (macro['ban1']==champion)|(macro['ban2']==champion)|(macro['ban3']==champion)|(macro['ban4']==champion)|(macro['ban5']==champion)
...
def get_df_champions_statistics(micro):
    stats = ['result', 'kills', 'deaths','assists', 'damageshare', 'earnedgoldshare', 'cspm', 'golddiffat15', 'xpdiffat15', 'csdiffat15']
